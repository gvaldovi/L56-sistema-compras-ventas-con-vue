                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" v-model="buscar" @keyup.enter="readArticulo(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                                <button type="submit" @click="readArticulo(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="createArticulo()">Guardar</button>
                        <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="updateArticulo()">Actualizar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            readArticulo (page,buscar,criterio){
                let me=this;
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                me.readArticulo(page,buscar,criterio);
            },
            createArticulo(){
        ...
        mounted() {
            this.readArticulo(1,this.buscar,this.criterio);
        }
    }
</script>
<style>    
